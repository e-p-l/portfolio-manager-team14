...
class PortfolioHistory(db.Model):
    ...
    balance = db.Column(db.Float, nullable=True)  # Added balance field
    date = db.Column(db.Date, nullable=False)

    portfolio = db.relationship('Portfolio', back_populates='history')

    def __init__(self, portfolio_id, value, date=None, balance=None):
        self.portfolio_id = portfolio_id
        self.value = value
        self.balance = balance  # Can be used for cash balance tracking
